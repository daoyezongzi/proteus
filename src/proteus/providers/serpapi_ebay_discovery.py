...
def _request_url(api_key: str, category_id: str, page: int) -> str:
...
def _base(category_id: str, retrieved_at: str, page: int) -> dict[str, Any]:
    return {
...
def _parameters_match(
    payload: Mapping[str, Any], category_id: str, page: int
) -> bool:
...
def collect_ebay_sold_candidates(
    *,
    ...
    outcome = _base(category_id, timestamp, page)
    ...
    if not _parameters_match(payload, category_id, page):
